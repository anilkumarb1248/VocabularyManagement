...
public class VocabularyHeaderController {
    ...
    @GetMapping
    public Callable<ResponseEntity<ListResponse<VocabularyHeader>>> getAllVocabularyHeaders(){
        ListResponse<VocabularyHeader> listResponse = new ListResponse<>();
        List<VocabularyHeader> allVocabularyHeaders = vocabularyHeaderService.getAllVocabularyHeaders();
